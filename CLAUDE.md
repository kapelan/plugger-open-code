...
`@plugger-open-code/claude-marketplace` — an **OpenCode plugin** that brings the **Claude Code plugin/marketplace ecosystem** into OpenCode. Mirrors Claude Code's `/plugin` UI as closely as the OpenCode plugin API allows.
